...
extension ColorSliderConfiguration {
    static var noop: Self {
        .init(
            gradientInvalidationHandler: { _ in fatalError() },
            colorToValue: { _ in 0 },
            valueToColor: { _, _ in .noop }
        )
    }
        ...
        .init(
            gradientInvalidationHandler: { color in
                CGGradient(
                    ...
                    colors: [
                        // Use sRBG
                        UIColor(red: 0, green: color.hsv.rgb.g, blue: color.hsv.rgb.b, alpha: 1)
                            .cgColor,
                        UIColor(red: 1, green: color.hsv.rgb.g, blue: color.hsv.rgb.b, alpha: 1)
                            .cgColor,
                    ] as CFArray,
                    locations: [0, 1]
                )!
        ...
        .init(
            gradientInvalidationHandler: { color in
                CGGradient(
                    ...
                    colors: [
                        // Use sRBG
                        UIColor(red: color.hsv.rgb.r, green: 0, blue: color.hsv.rgb.b, alpha: 1)
                            .cgColor,
                        UIColor(red: color.hsv.rgb.r, green: 1, blue: color.hsv.rgb.b, alpha: 1)
                            .cgColor,
                    ] as CFArray,
                    locations: [0, 1]
                )!
        ...
        .init(
            gradientInvalidationHandler: { color in
                CGGradient(
                    ...
                    colors: [
                        // Use sRBG
                        UIColor(red: color.hsv.rgb.r, green: color.hsv.rgb.g, blue: 0, alpha: 1)
                            .cgColor,
                        UIColor(red: color.hsv.rgb.r, green: color.hsv.rgb.g, blue: 1, alpha: 1)
                            .cgColor,
                    ] as CFArray,
                    locations: [0, 1]
                )!
